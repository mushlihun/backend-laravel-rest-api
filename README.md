## Laravel CRUD API with Auth
 It's included with JWT authentication and Swagger API format.
 Basic Laravel CRUD API application included with Authentication Module & Product Module.
...
```
1. Go to the project drectory by `cd backend-laravel-rest-api` & Run the
